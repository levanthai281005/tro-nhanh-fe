...
export function MapPlaceholder() {
  return (
    <div className="relative flex min-h-[400px] items-center justify-center overflow-hidden rounded-lg border border-line bg-sand-soft">
      <div
        aria-hidden="true"
        className="absolute inset-0 opacity-35 [background-image:linear-gradient(to_right,theme(colors.sand)_1px,transparent_1px),linear-gradient(to_bottom,theme(colors.sand)_1px,transparent_1px)] [background-size:48px_48px]"
      />
